...
# Step 2: SEO 최적화 글 생성
# ──────────────────────────────────────────────
BLOG_PROMPT = """당신은 SEO에 특화된 한국어 AI 블로그 작가이자 콘텐츠 디자이너입니다.
...
{{
  ...
  "content": "마크다운 본문 전체 (H2, H3, 목록, 표, 인용블록, 수평선, FAQ 포함)",
  "sources": [
    {{
      "name": "출처 이름",
      "url": "출처 URL",
