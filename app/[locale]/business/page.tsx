      ...
      <section className="py-24 bg-slate-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative h-72 lg:h-full min-h-[320px] rounded-2xl overflow-hidden">
              <Image
            ...
            <div>
              ...
              <h2 className="text-3xl lg:text-4xl font-extrabold text-on-surface font-headline mb-6">
                비용은 어떻게 되나요?
              </h2>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3">
                <a
                  href="mailto:contact@seroai.xyz"
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-primary text-white font-bold rounded-xl hover:bg-indigo-700 transition-colors text-sm"
                >
                  <span className="material-symbols-outlined text-base">mail</span>
                  무료 상담 요청
                </a>
                <a
                  href={lh("/posts")}
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-on-surface font-bold rounded-xl hover:bg-slate-100 transition-colors border border-slate-200 text-sm"
                >
                  직접 해볼래요
